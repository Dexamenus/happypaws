...
import petshop.dialog.AddNewUser;
import petshop.dialog.DeleteUser;
import petshop.dialog.EditUser;
...
public class ManageUsers extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel2.add(txtSearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 274, 39));
    ...
    public static void refreshData(String w){
        try {
            ...
            while (R.next()){                
             ...
             System.err.println("Gagal Refresh");
        }
    }
